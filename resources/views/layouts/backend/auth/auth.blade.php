...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('public/assets/backed/app-assets/css/themes/bordered-layout.css')}}">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('public/assets/backed/app-assets/css/plugins/forms/form-validation.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('public/assets/backed/app-assets/css/pages/page-auth.css')}}">
    <!-- END: Page CSS-->
...
<body class="vertical-layout vertical-menu-modern blank-page navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="blank-page">
                ...
                <div class="auth-wrapper auth-v2">
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                            <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img class="img-fluid" style="width:60%"src="{{asset('public/assets/backed/app-assets/images/pages/bookid.png')}}" alt="Login V2" /></div>
                        </div>
                        <!-- /Left Text-->
                        @yield('content')
                    </div>
    ...
    <script src="{{asset('public/assets/backed/app-assets/vendors/js/forms/validation/jquery.validate.min.js')}}"></script>
    <!-- END: Page Vendor JS-->
    ...
    <!-- BEGIN: Page JS-->
    <script src="{{asset('public/assets/backed/app-assets/js/scripts/pages/page-auth-login.js')}}"></script>
    <!-- END: Page JS-->
